    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/auth/users/*/onboarding").authenticated()
                        ...
                        .requestMatchers(HttpMethod.GET, "/jobs/saved").authenticated()
                        .requestMatchers(HttpMethod.POST, "/jobs/*/save").authenticated()
                        .requestMatchers(HttpMethod.DELETE, "/jobs/*/save").authenticated()
                        ...
                        .requestMatchers(HttpMethod.POST, "/support").authenticated()
                        .requestMatchers(HttpMethod.GET, "/support").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/support/*/resolve").hasRole("ADMIN")
